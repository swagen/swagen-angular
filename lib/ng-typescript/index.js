...
module.exports = class Generator {
    ...
    generate() {
        ...
        if (this.options.generation.generateModels) {
            this.generateModels();
        }
    ...
    generateInterfaces() {
        ...
        this.code
            .repeat(serviceNames, (code, serviceName, i) => {
                ...
                code.blank(i > 0)
                    .startBlock(`export interface I${serviceName}${this.options.generation.serviceClassSuffix}`)
    ...
    generateImplementation(serviceName, service) {
        ...
        this.code
            .line(`@Injectable()`)
            .inline(`export class ${serviceName}${this.options.generation.serviceClassSuffix}`)
                .inline(` implements I${serviceName}${this.options.generation.serviceClassSuffix}`, this.options.generation.generateInterfaces)
                .inline(` {`)
            .done()
            .indent()
                .inline(`private`)
